...
$filename = "images/32". $_FILES['file']['name'];

$filename1 = "images/100". $_FILES['file']['name'];

$filename2 = "images/250". $_FILES['file']['name'];

$filename3 = "images/150". $_FILES['file']['name'];
...
imagejpeg($tmp2,$filename2,250);

imagejpeg($tmp3,$filename3,250);
